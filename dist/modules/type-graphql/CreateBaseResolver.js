...
function createBaseResolver(suffix, returnType, inputType, entity, relations) {
    let BaseCreateResolver = class BaseCreateResolver {
        create(data) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield entity.create(data).save();
            });
        }
    };
    __decorate([
    ...
    ], BaseCreateResolver.prototype, "create", null);
    BaseCreateResolver = __decorate([
