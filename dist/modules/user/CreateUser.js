...
function createBaseResolver(suffix, returnType, inputType, entity) {
...
const BaseCreateUserResolver = createBaseResolver("User", User_1.User, RegisterInput_1.RegisterInput, User_1.User);
const BaseCreateProductResolver = createBaseResolver("Product", Product_1.Product, ProductInput, Product_1.Product);
let CreateUserResolver = class CreateUserResolver extends BaseCreateUserResolver {
};
CreateUserResolver = __decorate([
    type_graphql_1.Resolver()
], CreateUserResolver);
exports.CreateUserResolver = CreateUserResolver;
let CreateProductResolver = class CreateProductResolver extends BaseCreateProductResolver {
};
