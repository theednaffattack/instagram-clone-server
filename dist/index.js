...
const getContextFromHttpRequest = (req, res) =>
...
const main = () =>
  __awaiter(this, void 0, void 0, function*() {
    ...
    const apolloServer = new apollo_server_express_1.ApolloServer({
      ...
      formatError: error => {
        if (
          error.originalError instanceof apollo_server_express_1.ApolloError
        ) {
          return error;
        }
        const { extensions = {}, locations, message, path } = error;
        if (
          error.originalError instanceof type_graphql_1.ArgumentValidationError
        ) {
